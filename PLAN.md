...
| 10 | 02 | Not started | High | Medium | Publication | `docs/development/jobs/job-02-git-initial-readiness.md` | Prepare repo for initial git/GitHub publication with README, ignore rules, and release clarity. | Root README and `.gitignore` ready, publication risks called out. |
